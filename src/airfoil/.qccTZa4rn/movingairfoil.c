#line 0 "movingairfoil-cpp.c"
#line 0 "<built-in>"
#line 0 "<command-line>"
#line 1 "/usr/include/stdc-predef.h"
#line 0 "<command-line>"
#line 1 "movingairfoil-cpp.c"
#if 700 < 700
  #undef 700
  #define 700 700
#endif
...
#line 826 "/home/spencer/basilisk/src/common.h"
...
OMP(omp declare reduction (+ : coord :
      ...
      omp_out.y += omp_in.y,
      omp_out.z += omp_in.z))
#line 920 "/home/spencer/basilisk/src/common.h"
...
#line 965 "/home/spencer/basilisk/src/common.h"
...
#line 456 "/home/spencer/basilisk/src/heights.h"
vector height;
...
#line 1281 "/home/spencer/basilisk/src/common.h"
...
if (loop->listf.y)
      flux = true;
  if (flux) {
#line 359 "/home/spencer/basilisk/src/grid/stencils.h"
...
#line 1462 "/home/spencer/basilisk/src/common.h"
#line 14 "movingairfoil-cpp.c"
...
#line 2 "/home/spencer/basilisk/src/grid/tree.h"
...
#line 7 "/home/spencer/basilisk/src/grid/tree.h"
#line 24 "/home/spencer/basilisk/src/grid/tree.h"
typedef struct {
...
#line 243 "/home/spencer/basilisk/src/grid/tree.h"
...
#line 284 "/home/spencer/basilisk/src/grid/tree.h"
...
#line 344 "/home/spencer/basilisk/src/grid/tree.h"
#line 361 "/home/spencer/basilisk/src/grid/tree.h"
...
#line 407 "/home/spencer/basilisk/src/grid/tree.h"
...
#line 524 "/home/spencer/basilisk/src/grid/tree.h"
...
#line 557 "/home/spencer/basilisk/src/grid/tree.h"
}
...
#line 601 "/home/spencer/basilisk/src/grid/tree.h"
    if (!(cell.pid < 0)) {
...
#line 823 "/home/spencer/basilisk/src/grid/tree.h"
...
#line 938 "/home/spencer/basilisk/src/grid/tree.h"
...
#line 971 "/home/spencer/basilisk/src/grid/tree.h"
  }
...
#line 1000 "/home/spencer/basilisk/src/grid/tree.h"
...
#line 1041 "/home/spencer/basilisk/src/grid/tree.h"
...
#line 1124 "/home/spencer/basilisk/src/grid/tree.h"
    }end_foreach_mem();}
...
static bool diagonal_neighbor_3D (Point point,
      scalar * scalars, vector * vectors)
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
#line 1266 "/home/spencer/basilisk/src/grid/tree.h"
  return false;
}
...
#line 1454 "/home/spencer/basilisk/src/grid/tree.h"
...
{tracing("init_grid","/home/spencer/basilisk/src/grid/tree.h",0);
  ...
  Layer * L = new_layer (0);
  q->L[0] = L;
#line 1537 "/home/spencer/basilisk/src/grid/tree.h"
...
#line 1575 "/home/spencer/basilisk/src/grid/tree.h"
...
#line 136 "/home/spencer/basilisk/src/grid/events.h"
...
t.y.y = alloc_block_scalar (name, ext.y, 1);
    ...
    t.y.x = t.x.y;
#line 248 "/home/spencer/basilisk/src/grid/cartesian-common.h"
  init_tensor (t, NULL);
  return t;
}
 ...
 inside = false;
    if (inside) {
      ...
      fprintf (fp, "%g %g\n%g %g\n%g %g\n%g %g\n%g %g\n\n",
        ...
        x + Delta, y - Delta,
        x - Delta, y - Delta);
#line 655 "/home/spencer/basilisk/src/grid/cartesian-common.h"
    }
  }end_foreach();}
  fflush (fp);
}
#line 667 "/home/spencer/basilisk/src/grid/cartesian-common.h"
...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  ...
  fputc ('\n', fp);
#line 734 "/home/spencer/basilisk/src/grid/cartesian-common.h"
    for (int k = -2; k <= 2; k++)
      for (int l = -2; l <= 2; l++) {
 {scalar*_i=(scalar*)( all);if(_i)for(scalar v=*_i;(&v)->i>=0;v=*++_i){ {
   fprintf (fp, "%g %g ",
...
#line 764 "/home/spencer/basilisk/src/grid/cartesian-common.h"
  fclose (fp);
...
#line 834 "/home/spencer/basilisk/src/grid/cartesian-common.h"
}
...
#line 1670 "/home/spencer/basilisk/src/grid/tree.h"
...
#line 1685 "/home/spencer/basilisk/src/grid/tree.h"
...
#line 1686 "/home/spencer/basilisk/src/grid/tree.h"
#else
void mpi_boundary_refine (scalar * list){}
...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
 ...
 val += (fine(s,0,i,j) + fine(s,1,!i,!j))/2., nv++;
  ...
  if (!(nv > 0.)) qassert ("/home/spencer/basilisk/src/embed-tree.h", 0, "nv > 0.");
  val(s,0,0,0) = val/nv;
...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  {foreach_child() {
    if (!val(cs,0,0,0))
      ...
      if (!(coarse(cs,0,0,0))) qassert ("/home/spencer/basilisk/src/embed-tree.h", 0, "coarse(cs)");
 ...
 if (!(coarse(cs,child.x,0,0) && coarse(cs,0,child.y,0))) qassert ("/home/spencer/basilisk/src/embed-tree.h", 0, "coarse(cs,child.x) && coarse(cs,0,child.y)");
 if (coarse(fs.x,i,child.y,0) && coarse(fs.y,child.x,j,0)) {

   if (!(coarse(cs,child.x,child.y,0))) qassert ("/home/spencer/basilisk/src/embed-tree.h", 0, "coarse(cs,child.x,child.y)");
...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  ...
  if (!(val(cs,i,0,0) && val(cs,i-1,0,0))) qassert ("/home/spencer/basilisk/src/embed.h", 0, "cs[i] && cs[i-1]");
...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  ...
  if (!(val(cs,0,i,0) && val(cs,0,i-1,0))) qassert ("/home/spencer/basilisk/src/embed.h", 0, "cs[i] && cs[i-1]");
...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  if (!(2 == 2)) qassert ("/home/spencer/basilisk/src/embed.h", 0, "dimension == 2");
...
{tracing("fractions_cleanup","/home/spencer/basilisk/src/embed.h",0);
...
schanged += changed;
  ...
  if (changed)
    fprintf (ferr, "WARNING: fractions_cleanup() did not converge after "
      "%d iterations\n", i);
  {end_tracing("fractions_cleanup","/home/spencer/basilisk/src/embed.h",0);return schanged;}
end_tracing("fractions_cleanup","/home/spencer/basilisk/src/embed.h",0);}
...
#line 604
  ...
  *Fp = Fps; *Fmu = Fmus;
end_tracing("embed_force","/home/spencer/basilisk/src/embed.h",0);}
...
end_tracing("update_tracer","/home/spencer/basilisk/src/embed.h",0);}
#line 895
...
#line 895 "/home/spencer/basilisk/src/embed.h"
      static int metric(const int i,const double t,Event *_ev){tracing("metric","/home/spencer/basilisk/src/embed.h",0);
{
  if (is_constant (fm.x)) {
    
      if (!(constant (fm.x) == 1.)) qassert ("/home/spencer/basilisk/src/embed.h", 0, "constant (fm.x) == 1.");
      
#line 899
if (!(constant (fm.y) == 1.)) qassert ("/home/spencer/basilisk/src/embed.h", 0, "constant (fm.x) == 1.");
    fm = fs;
  }
  foreach_face_stencil(1,{(NonLocal[]){{"fs","vector",(void *)&fs,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n// #line 902 \"/home/spencer/basilisk/src/embed.h\"\n{is_face_x(){\n    val_out_(fs.x,0,0,0) = 1.;}end_is_face_x()\n// #line 902\nis_face_y(){\n    val_out_(fs.y,0,0,0) = 1.;}end_is_face_y()}"}){_stencil_is_face_x(){
...
}{end_tracing("metric","/home/spencer/basilisk/src/embed.h",0);return 0;}end_tracing("metric","/home/spencer/basilisk/src/embed.h",0);}
...
#line 938
      static int defaults(const int i,const double t,Event *_ev){tracing("defaults","/home/spencer/basilisk/src/embed.h",0); {
...
}{end_tracing("defaults","/home/spencer/basilisk/src/embed.h",0);return 0;}end_tracing("defaults","/home/spencer/basilisk/src/embed.h",0);}
#line 2 "movingairfoil.c"
#line 1 "navier-stokes/centered.h"
#line 1 "/home/spencer/basilisk/src/navier-stokes/centered.h"
#line 27 "/home/spencer/basilisk/src/navier-stokes/centered.h"
#line 1 "./run.h"
...
#line 187 "/home/spencer/basilisk/src/utils.h"
...
#line 213 "/home/spencer/basilisk/src/utils.h"
double theta = 1.3;
...
#line 237 "/home/spencer/basilisk/src/utils.h"
...
#line 280 "/home/spencer/basilisk/src/utils.h"
...
#line 340 "/home/spencer/basilisk/src/utils.h"
...
#line 410 "/home/spencer/basilisk/src/utils.h"
...
#line 120 "/home/spencer/basilisk/src/output.h"
...
#line 149 "/home/spencer/basilisk/src/output.h"
...
#line 300 "/home/spencer/basilisk/src/output.h"
...
#line 534 "/home/spencer/basilisk/src/output.h"
...
#line 649 "/home/spencer/basilisk/src/output.h"
...
#line 718 "/home/spencer/basilisk/src/output.h"
...
{tracing("output_gfs","/home/spencer/basilisk/src/output.h",0);
 ...
 3;
#line 851 "/home/spencer/basilisk/src/output.h"
      if (is_leaf(cell))
 flags |= (1 << 4);
...
#line 943 "/home/spencer/basilisk/src/output.h"
struct DumpHeader {
  double t;
  long len;
...
{tracing("restore","/home/spencer/basilisk/src/output.h",0);
  ...
  ((Tree *)grid)->dirty = true;
#line 1157 "/home/spencer/basilisk/src/output.h"
...
#line 1232 "/home/spencer/basilisk/src/output.h"
  scalar * listm = is_constant(cm) ? NULL : (scalar *)((vector[]){fm,{{-1},{-1}}});
...
#line 431 "/home/spencer/basilisk/src/utils.h"
...
#line 357 "/home/spencer/basilisk/src/input.h"
...
static scalar compile_expression (char * expr, bool * isexpr)
{
  *isexpr = false;
  ...
  foreach_stencil(1,{(NonLocal[]){{"node","not implemented yet",(void *)node,NULL,1},{"undefined","double",(void *)&undefined,NULL,0},{"ferr","not implemented yet",(void *)ferr,NULL,1},{"s","scalar",(void *)&s,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"\n@ def not_mpi_compatible()\ndo {\n  if (npe() > 1) {\n    fprintf (ferr, \"%s() is not compatible with MPI (yet)\\n\", __func__);\n    exit (1);\n  }\n} while(0)\n@\n@ define system(command) (pid() == 0 ? system(command) : 0)\n@else\n@ define qstderr() stderr\n@ define qstdout() stdout\n@ define ferr stderr\n@ define fout stdout\n@ define not_mpi_compatible()\n@endif\n\n\n\n\n// #line 93 \"/home/spencer/basilisk/src/common.h\"\nstatic inline void qassert (const char * file, int line, const char * cond) {\n  fprintf (ferr, \"%s:%d: Assertion `%s' failed.\\n\", file, line, cond);\n  abort();\n}\n\n\n// #line 399 \"/home/spencer/basilisk/src/draw.h\"\nstatic real evaluate_expression (Point point, Node * n)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  if (!(n)) qassert (\"/home/spencer/basilisk/src/draw.h\", 0, \"n\");\n  switch (n->type) {\n  case '1': return n->d.value;\n  case '+': return (evaluate_expression (point, n->e[0]) +\n      evaluate_expression(point, n->e[1]));\n  case '-': return (evaluate_expression (point, n->e[0]) -\n      evaluate_expression(point, n->e[1]));\n  case '*': return (evaluate_expression (point, n->e[0]) *\n      evaluate_expression(point, n->e[1]));\n  case '/': return (evaluate_expression (point, n->e[0]) /\n      evaluate_expression(point, n->e[1]));\n  case '^': return pow (evaluate_expression (point, n->e[0]),\n   evaluate_expression(point, n->e[1]));\n  case '>': return (evaluate_expression (point, n->e[0]) >\n      evaluate_expression(point, n->e[1]));\n  case '<': return (evaluate_expression (point, n->e[0]) <\n      evaluate_expression(point, n->e[1]));\n  case 'L': return (evaluate_expression (point, n->e[0]) <=\n      evaluate_expression(point, n->e[1]));\n  case 'G': return (evaluate_expression (point, n->e[0]) >=\n      evaluate_expression(point, n->e[1]));\n  case '=': return (evaluate_expression (point, n->e[0]) ==\n      evaluate_expression(point, n->e[1]));\n  case 'i': return (evaluate_expression (point, n->e[0]) !=\n      evaluate_expression(point, n->e[1]));\n  case 'O': return (evaluate_expression (point, n->e[0]) ||\n      evaluate_expression(point, n->e[1]));\n  case 'A': return (evaluate_expression (point, n->e[0]) &&\n      evaluate_expression(point, n->e[1]));\n  case '?': return (evaluate_expression (point, n->e[0]) ?\n      evaluate_expression(point, n->e[1]) :\n      evaluate_expression(point, n->e[2]));\n  case 'm': return - evaluate_expression (point, n->e[0]);\n  case 'f': return n->d.func (evaluate_expression (point, n->e[0]));\n  case 'v': {\n    scalar s = {n->s};\n    int k[3] = {0,0,0};\n    for (int i = 0; i < 3; i++)\n      if (n->e[i])\n k[i] = evaluate_expression (point, n->e[i]);\n    return val(s,k[0],k[1],k[2]);\n  }\n  case 'D': return Delta;\n  case 'x': return x;\n  case 'y': return y;\n  case 'z': return z;\n  default:\n    fprintf (ferr, \"unknown operation type '%c'\\n\", n->type);\n    if (!(false)) qassert (\"/home/spencer/basilisk/src/draw.h\", 0, \"false\");\n  }\n  return undefined;\n}","\n    \n// #line 532 \"/home/spencer/basilisk/src/draw.h\"\nval_out_(s,0,0,0) = evaluate_expression (point, node);"})
...
{tracing("isoline","/home/spencer/basilisk/src/draw.h",0);
  ...
  if (!is_vertex_scalar (col)) {
    ...
    foreach_vertex_stencil(1,{(NonLocal[]){{"col","scalar",(void *)&col,NULL,0},{"fphi","scalar",(void *)&fphi,NULL,0},{"val","double",(void *)&val,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n      \n// #line 1084 \"/home/spencer/basilisk/src/draw.h\"\nval_out_(fphi,0,0,0) = (val(col,0,0,0) + val(col,-1,0,0) + val(col,0,-1,0) + val(col,-1,-1,0))/4.;"})
...
{tracing("squares","/home/spencer/basilisk/src/draw.h",0);
  ...
  if (z) {
    ...
    fn = new_vector("fn");
    foreach_stencil(1,{(NonLocal[]){{"Z","scalar",(void *)&Z,NULL,0},{"fn","vector",(void *)&fn,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n      \n// #line 1244 \"/home/spencer/basilisk/src/draw.h\"\n{\n        val_out_(fn.x,0,0,0) = (val(Z,1,0,0) - val(Z,-1,0,0))/(2.*Delta_x);\n        \n// #line 1245\nval_out_(fn.y,0,0,0) = (val(Z,0,1,0) - val(Z,0,-1,0))/(2.*Delta_y);}"})
      {
