...
double SDF cylinder (double xx, double yy) {
  return - sq(xx - ci.x) - sq(yy - ci.y) + sq(D/2);
}
...
event moving_cylinder (i++) {
  ...
  //cylinder (airfoil, sf, phia);
  //cylinder (reference, rf);
