...
event moving_cylinder (i++) {
  ...
  foreach() {
     ...
     // fprintf (stderr, "i=%d t=%g n.x=%g n.y=%g lam=%g eta=%g vof_b=%g vof_a=%g x=%g y=%g delta=%g num=%g den=%g\n",
//	      i, t, nv.x[], nv.y[], lambda, eta, vof, airfoil[], x, y, Delta, num, den);
  }
}
